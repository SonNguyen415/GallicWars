/// @description Wave Alarm
// You can write your code in this editor

if(spawn_wave < MAX_WAVE) {
	spawn_wave++;

	var _num_dir = 1;

	announce = true;
	global.curr_game = IN_GAME;
	alarm[1] = 100;
	...
	for(var _k=0; _k<_num_dir; _k++) {
		...
		for(var _i=0; _i<_root_enemies; _i++) {
			...
			for(var _j= 0; _j <_root_enemies; _j++) {
				...
				// Determine troop type. Infantry first to make sure cavalry has higher chance of higher rank
				if(_num_inf > 0) {
